...
# === PHASE 1a: damped-driven coupled-oscillator mechanics ===
# === FILL FROM PAPER === (supp p3-4)


# === PHASE 1b: bond-event Arrhenius rates ===
# === FILL FROM PAPER === (supp p5-6 for catch; supp p13 for snap)


# === PHASE 1c: Gillespie on graph state space ===
# === FILL FROM PAPER === (standard Gillespie + supp p4 time-scale separation)


# === PHASE 1d: reproduce Fig 2 (main text) + Fig S8 (supp) ===
