...
> 1. `kachman.py` Phase 1d-ii: reproduce Kachman's green snap-bond curve (Fig S8) via the same Still-bound machinery as catch, on the same reference impl. Pending.
